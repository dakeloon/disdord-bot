...
namespace DiscordBot
{
    ...
    class Program
    {
        ...
        System.Timers.Timer timer = new System.Timers.Timer() { Interval = 180000 };
        static int task = 1;
        ...
        {
            string path = @"C:\Users\sg421\OneDrive\Desktop\bot.txt";
            string line;
            int LineNumber = 1;
        ...
        private async Task MainAsync()
        {
            ...
            var Token = "OTc2NDM1NDQ0NDk1NTgxMjI0.GbGaZy.K1HmtgHStGr-3y3NKsTLq-4LnaVSk_PBY7T95g";
